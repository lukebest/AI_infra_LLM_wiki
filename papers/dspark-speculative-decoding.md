...
**Authors:** Xin Cheng, Xingkai Yu, Chenze Shao, Jiashi Li, Yunfan Xiong, et al. | **Affiliations:** Peking University + DeepSeek-AI | **PDF:** `raw/papers/DSpark_Confidence-Scheduled_Speculative_Decoding_2026.pdf`（非公开本地路径）
...
[1] `raw/papers/DSpark_Confidence-Scheduled_Speculative_Decoding_2026.pdf`（非公开本地路径） — Cheng et al. (2026)
